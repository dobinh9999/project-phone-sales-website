...
namespace Smartphonev3.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "danh_muc_id,ten_danh_muc,mo_ta_danh_muc")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "danh_muc_id,ten_danh_muc,mo_ta_danh_muc")] DanhMuc danhMuc)
        {
            if (ModelState.IsValid)
            {
